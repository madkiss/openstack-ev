...
\date{}
\author{}
\def\fassungsdatum{16.\ September 2015}
...
{\footnotesize Diese Vereinssatzung wurde am ??.\ ??.\ 2015 in der
  Mitgliederversammlung des Vereins "`\VereinsName\ e.V."\ offiziell errichtet. Sie
...
Der Verein führt den Namen "`\VereinsName\ e.V."' (fortan: der Verein).
...
\label{Zweck}
Zweck der Körperschaft ist die Förderung von Volksbildung. Der Satzungszweck wird insbesondere verwirklicht durch

\begin{enumerate}
  \item die Durchführung von wissenschaftlichen Veranstaltungen, Bildungsveranstaltungen und Kursen zum Thema Cloud Computing und OpenStack,
  \item die Veröffentlichung von Informationen zu OpenStack und verwandten Themen
  \item den Betrieb von Internet-Foren für den wissenschaftlichen Austausch und die Verbreitung des Wissens um OpenStack.
\end{enumerate}
